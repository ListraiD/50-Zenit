				...
				<div class="row">
					...
					<div class="col-8 mx-auto">
						<div class="premcolor rad pb-2 pt-2">
							<textarea class="form-control premcolor hh" value="" name="name"></textarea>
						</div>
				...
				<div class="row">
					...
					<div class="col-8 pl-2 pr-2 borderblackkk ">
						<div class="pb-2 pt-2 mt-3 maincolorb rad pb-5">
							...
							<h3 class="text-center hhw">список компани: <span class="hhb">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
