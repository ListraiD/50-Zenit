        ...
        <div class="col-8 row mx-auto pr-0 pl-0">
            ...
            <div class="col-6 pr-5">
                <div class=" col-12 bordertopbotblack pt-3 pb-3 ">
                    <p style=" color: black" class="h3 a2 text-center">SIGN UP</p>
                </div>
                <form action="compinsert.php" method="POST" enctype="multipart/form-data" >
                    ...
                    <div class="mx-auto col-12">
                        <input  class="mt-5 col-12 pt-3 pb-3 aa borderblackk" placeholder="password" type="" name="password">
                    </div>
                    <div class="mx-auto col-12">
